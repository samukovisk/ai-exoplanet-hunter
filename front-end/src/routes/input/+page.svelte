...
<section class="hero mt-10">
        <h1 class="text-white">Input Data</h1>
        <p class="text-white font-semibold">
            This page is where you submit astronomical data for analysis by our AI. The process is simple: just download the template, upload your data file, and submit it for classification. You can then view the clear and detailed results generated by the model, complete with explanations and charts.
        </p>
</section>
    ...
    <div class="container">
        <!-- Mass Upload Card -->
        <div class="upload-card text-white">
            <h2>Mass Upload</h2>
            ...
            <div class="upload-description">
                ...
                we ask that you follow our standard format. First, download our guide template and after filling it with the data for your potential exoplanet, return here to 
...
<style>
    ...
    :global(body) {
        ...
        background: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)),url('/bg-inputdata.png');
